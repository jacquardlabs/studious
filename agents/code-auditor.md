---
name: code-auditor
description: Code quality auditor. Reviews a changeset for patterns, maintainability, complexity, consistency, language idioms, and error handling. Diff-scoped and gate-invoked (/review) — not the periodic whole-codebase review.
