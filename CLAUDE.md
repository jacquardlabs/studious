...
- **Every agent/command reads PRODUCT.md, DESIGN.md, or CLAUDE.md** for project context. The 16 review/audit agents share a standardized prompt contract (posture, output format, calibration) — match it when adding an agent.
